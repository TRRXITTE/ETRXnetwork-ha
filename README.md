[![NPM](https://nodei.co/npm/@trrxitte/etrxnetwork-ha.png?downloads=true&stars=true)](https://nodei.co/npm/@trrxitte/etrxnetwork-ha/)

[![Build Status](https://travis-ci.org/trrxitte/etrxnetwork-ha.png?branch=master)](https://travis-ci.org/trrxitte/etrxnetwork-ha) [![Build Status](https://ci.appveyor.com/api/projects/status/github/trrxitte/etrxnetwork-ha?branch=master&svg=true)](https://ci.appveyor.com/project/trrxitte/etrxnetwork-ha/branch/master)

# ETRXnetwork High-Availability Daemon Wrapper

This project is designed to wrap the ETRXnetwork daemon on a *nix system and monitor it for hangups, locks, fork, or other events that cause the daemon to stop responding to requests in an accurate manner.
...
5. [Documentation](#documentation)
   1. [Methods](#methods)
   2. [Events](#events)
   3. [ETRXnetwork RPC API Interface](#traaittplatform-rpc-api-interface)
...
* [ETRXnetwork](https://github.com/TRRXITTE/traaittPlatform/releases) v4.4.7 or higher
...
pm2 start service.js --name ETRXnetwork
pm2 save
```
...
Practically all ETRXnetwork command line arguments are exposed in the constructor method. Simply include them in your list of options to get activate or use them. Default values are defined below.

```javascript
var daemon = new ETRXnetwork({
  // These are our ETRXnetwork-ha options
  ...
  // These are the standard ETRXnetwork options
  path: './ETRXnetwork', // Where can I find ETRXnetwork?
...
This event is emitted when the daemon starts. The callback contains the command line arguments supplied to ETRXnetwork.
